...
const IndependentDashboardLayout = ({ children, title = "", headerAction = null, titleAction = null, gpnumber = "", }) => {
    ...
    const navItems = [
        { name: "Appointments", icon: AppointmentsIcon, path: "/independent/dashboard/appointments/current-bookings" },
        { name: "Post A Project", icon: PostIcon, path: "/independent/dashboard/post-project" },
        { name: "Services", icon: ServicesIcon, path: "/independent/dashboard/services" },
        { name: "Discount & Promotion", icon: DiscountsIcon, path: "/independent/dashboard/discounts" },
        { name: "Availability Management", icon: AvailabilityIcon, path: "/independent/dashboard/availability-management" },
        { name: "Reviews", icon: ReviewsIcon, path: "/independent/dashboard/reviews" },
        { name: "Chat", icon: ChatIcon, path: "/independent/dashboard/chat" },
        { name: "Earning", icon: EarningsIcon, path: "/independent/dashboard/earning" },
        { name: "Payments", icon: PaymentsIcon, path: "/independent/dashboard/payments" },
        { name: "Gift Cards", icon: GiftCardsIcon, path: "/independent/dashboard/gift-cards" },
        { name: "Family & Friends", icon: FamilyFriendsIcon, path: "/independent/dashboard/family-friends" },
        { name: "Customer Forms", icon: Customer, path: "/independent/dashboard/customer-forms" },
        { name: "Favorite", icon: FavoriteIcon, path: "/independent/dashboard/favorite" },
        { name: "Know More", icon: AvailabilityIcon, path: "/independent/dashboard/know-more/about-us" },
    ];
                    ...
                    <div className="flex items-center justify-between w-full sm:w-auto mt-2 sm:mt-0">
                        ...
                        <div className="client-navbar-icons">
                            <div className="w-[30px] h-[30px] bg-[#F5F7FA] rounded-full flex items-center justify-center cursor-pointer text-[#FFCC4E] flex-shrink-0 hover:bg-[#FFCC4E] hover:text-[#FFFFFF] transition duration-300"
                                onClick={() => navigate('/independent/dashboard/basket')}
                            >
                                <IoMdCart />
                            </div>
                            <div className="w-[30px] h-[30px] bg-[#F5F7FA] rounded-full flex items-center justify-center cursor-pointer text-[#718EBF] flex-shrink-0 hover:bg-[#718EBF] hover:text-[#FFFFFF] transition duration-300"
                                onClick={() => navigate('/independent/dashboard/account-setting')}
                            >
                                <IoSettingsOutline />
                            </div>
...
export default IndependentDashboardLayout;