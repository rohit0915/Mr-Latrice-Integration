 ...
 */
const ClientDashboardLayout = ({ children, title = "", headerAction = null, titleAction = null, gpnumber = "", }) => {
    ...
    <div className="flex h-screen bg-[#FAF9F6] relative overflow-x-hidden">
      ...
      >
        ...
        <div className="w-full px-4 pb-12 mt-2">
          ...
          >
            <div className="flex items-center px-4 py-3 text-sm group hover:bg-[#FFE6D8] hover:rounded-[15px] hover:shadow-md transition-colors duration-200">
