...
import { AppointmentRescheduleRequest } from "./AppointmentRescheduleRequest";
...
const ChatBox = ({ user, messages, setMessages }) => {
  ...
  const isLatrice = user.id === 1;
  const isLatrice1 = user.id === 2;
    ...
    <>
      ...
      <div className="flex flex-col h-full bg-white">
        ...
        {isLatrice ? (
          ...
          <AppointmentRescheduleRequest user={user} />
        ) : (
          <>
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
