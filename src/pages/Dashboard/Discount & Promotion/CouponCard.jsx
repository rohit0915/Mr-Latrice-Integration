...
const CouponCard = () => {
    return (
        <div className="flex flex-col md:flex-row rounded-tl-[20px] rounded-bl-[20px] shadow-md overflow-hidden w-full max-w-fit bg-[#FFFFFF]">
            {/* Left side */}
            <div className="p-3">
            ...
            {/* Right side */}
            <div className="relative text-white p-4 md:w-48 flex flex-col items-center justify-center text-center border-l border-dashed border-gray-400"
                style={{
