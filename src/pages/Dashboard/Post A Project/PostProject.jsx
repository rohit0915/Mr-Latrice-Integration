...
import { AddDateTimeModal, AddSelectTargetModal, AddServiceDetailsModal, AddServiceModal, AddSuccessModal, AddValidationModal, PostAProject } from "../../../components/Modals/Modal";
...
export default function PostProject() {
    ...
    return (
        <ClientDashboardLayout title="Post A Project"
            headerAction={
