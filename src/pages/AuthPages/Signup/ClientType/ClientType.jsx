        ...
        <div className="w-full max-w-4xl mx-auto">
          ...
          <div className="mb-6 relative">
            ...
            <div className="flex justify-between relative">
              ...
              {/* Step 2 - Validation */}
              <div className="text-center">
                <div className="w-10 h-10 bg-gray-200 text-gray-600 rounded-full flex items-center justify-center mx-auto font-medium">
                  2
                </div>
              ...
              >
                <div className="flex gap-1 items-center justify-center mb-1">
                  <div className="rounded-md p-1">
                    <img src={UplaodBar} className="object-contain w-full" alt="upload" />
                  </div>
