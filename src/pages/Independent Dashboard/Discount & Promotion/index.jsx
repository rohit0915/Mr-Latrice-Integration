...
const IndependentDiscountPromotion = () => {
    ...
    return (
        <IndependentDashboardLayout title="Discount & Promotion">
            <AddaMember
                isOpen={isModalOpen}
                onClose={() => setModalOpen(false)}
            />
            <div className="">
                <div className='flex items-center justify-between flex-wrap sm:gap-0 gap-5 mb-5'>
...
export default IndependentDiscountPromotion