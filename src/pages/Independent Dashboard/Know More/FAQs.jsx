...
const IndependentFAQs = () => {
  const [searchTerm, setSearchTerm] = useState("");
  const [filter, _setFilter] = useState("all");
  const [activeTab, setActiveTab] = useState("all"); // 'all' or 'client'

  // For toolbar filter dropdown
  //   const filterOptions = [
  //     { label: "All", value: "all" },
  //     { label: "Using the Platform", value: "platform" },
  //     { label: "Payment & Earnings", value: "payment" },
  //     { label: "Booking & Cancellations", value: "booking" },
  //     { label: "Policies & Terms", value: "policies" },
  //   ];

  // For navigation tabs (reuse if needed)
  const routeMapping = {
  ...
  return (
    <IndependentDashboardLayout title="FAQs">
...
export default IndependentFAQs;
