                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <h6 className="font-[400] font-rasa sm:text-[17px] text-[14px] text-[#989BA1] group-hover:text-white">
                                        {user.name}
                                    </h6>
                                    <p className="font-[400] font-rasa sm:text-[12px] text-[10px] text-[#989BA1] group-hover:text-white">
                                        {user.role}
                                    </p>
                                </div>
                            </div>
                            <span className="font-[500] font-rasa sm:text-[13px] text-[10px] text-[#989BA1] group-hover:text-white">
                                {user.time}
                            </span>
                        </div>
                        <h6 className="font-[400] font-rasa sm:text-[13px] text-[10px] text-[#989BA1] mt-3 ml-4 group-hover:text-white">
                            {user.message}
                        </h6>
                    </div>
                ))}
