...
import img from "../../../assets/images/dashboard/img67.jpg";
import { RiDeleteBin6Fill } from "react-icons/ri";
import { BiSolidEditAlt } from "react-icons/bi";
import { IoIosClock } from "react-icons/io";
import { useNavigate } from "react-router-dom";

const StaffsCards = ({ setModalOpen }) => {
  ...
  return (
    <div className="bg-white rounded-[20px] shadow-[0px_4px_4px_0px_#00000040] ">
      ...
      <div className="flex items-start gap-3 p-2 relative">
        ...
        <div className="space-y-1 mr-5">
          ...
          <p className="flex items-center justify-between font-sansation font-[700] sm:text-[20px] text-[15px] text-charcoal ">
            <span className="">Experience In:</span>
            Hair Service
          </p>
          <p className="flex items-center justify-between font-sansation font-[700] sm:text-[20px] text-[15px] text-charcoal ">
      ...
      <div className="flex items-center mt-2">
        <button
          className="w-full bg-[#97E7EC] text-[#123E41] font-semibold sm:text-[20px] text-lg px-2 py-2 rounded-bl-[20px] shadow-[0px_4px_4px_0px_#00000040] hover:bg-[#6cc8cf] transition flex gap-1 items-center justify-center"
        ...
        <button
          className="w-full bg-[#FFE6D8] text-[#FF827F] font-semibold sm:text-[20px] text-lg px-2 py-2  rounded-br-[20px] shadow-[0px_4px_4px_0px_#00000040] hover:bg-[#fbbcb5] transition flex gap-1 items-center justify-center"
