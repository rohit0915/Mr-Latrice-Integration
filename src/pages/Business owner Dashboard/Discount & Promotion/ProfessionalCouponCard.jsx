...
import img1 from '../../../assets/images/dashboard/img69.png'
import { useNavigate } from 'react-router-dom';

const ProfessionalCouponCard = () => {
    const [isdicountcard, setDicountCard] = useState(false);
        ...
        <>
            {isdicountcard ?
                ...
                <div className="flex flex-col items-center text-center px-4 py-6">
                    ...
                    <h6 className='font-[500] text-[40px] text-charcoal font-rasa'>Add Your Discount</h6>
                    ...
                    <div className="mt-6 flex justify-center">
                        <button className="bg-[#FFE6D8] text-[#FF827F] font-semibold text-lg px-4 py-3 sm:w-[400px] rounded-md shadow-[0px_4px_4px_0px_#00000040] hover:bg-[#fbbcb5] transition"
                            onClick={() => navigate('/business-owner/dashboard/discounts/create')}
                        >
                            Create Discount
                        </button>
                    </div>
