...
const BusinessFamilyandFriends = () => {
    ...
    return (
        <BusinessOwnerDashboardLayout title="Family & Friends"
            headerAction={
                isfamilycard && (
                    <button
                    ...
                    <div className="mt-2">
                        ...
                        <div className="grid grid-cols-2 gap-5 mt-2">
                            {data.connectedMembers.map((member) => (
                                <FamilyCards key={member.id} data={member} showmodal={() => setModalOpen(true)}/>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="mt-5">
                        ...
                        <div className="grid grid-cols-2 gap-5 mt-2">
                            {data.pendingInvitations.map((invitation) => (
                                <FamilyCards key={invitation.id} data={invitation} isPending showmodal={() => setModalOpen(true)}/>
                            ))}
                        </div>
                    </div>
                </>
